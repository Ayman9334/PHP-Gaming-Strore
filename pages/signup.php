    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="../templates/signupP.php" method="post">

                    <span class="login100-form-title p-b-43 pb-5">
                        SIGN UP TO CONTINUE
                    </span>
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="wrap-input100-n validate-input pe-1" data-validate="First Name is required">
                            <input class="input100" type="text" name="fname">
                            <span class="focus-input100"></span>
                            <span class="label-input100">First Name</span>
                        </div>

                        <div class="wrap-input100-n validate-input ps-1" data-validate="Last Name is required">
                    ...
                    <div class="text-center p-t-46 p-b-20">
                        <span class="txt1">
                            or <a href="login.php" style="text-decoration: none;color: #6ad048;">login</a> to continue
                        </span>
                    </div>
                </form>
